...
$query = $pdo->query("SELECT products.*, categories.*, packaging.* FROM products LEFT JOIN categories ON products.category_id=categories.id_category LEFT JOIN packaging ON products.packaging_id=packaging.id_packaging ORDER BY products.name_product DESC LIMIT 15");
// Include config file
?>
<h2>Produits</h2>
<section class="produits">
<ul id="produits" class="produits__main">
