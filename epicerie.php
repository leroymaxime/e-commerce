...
$query = $pdo->query('SELECT products.*, categories.*, packaging.* FROM products LEFT JOIN categories ON products.category_id=categories.id_category LEFT JOIN packaging ON products.packaging_id=packaging.id_packaging WHERE categories.name_category = "Epicerie"');
?>
